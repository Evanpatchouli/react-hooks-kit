...
type RenderFunction<T extends object = {}> = (item: ItemExtended<T>, index: number, array: ItemExtended<T>[]) => JSX.Element;
...
declare function useList<T extends object = {}>(initialItems: Item<T>[], options?: UseListOptions<T>, dependencies?: DependencyList[]): [
    ItemExtended<T>[],
    {
