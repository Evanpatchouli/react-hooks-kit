...
function useDebounce(fn, delay, immediate, callback) {
    ...
    var fnRef = react.useRef(fn);
    var optionsRef = react.useRef({ immediate: immediate, callback: callback });
    fnRef.current = fn;
...
function useResize(_a, deps) {
    ...
    if (deps === void 0) { deps = []; }
    var _c = __read(react.useState({ width: 0, height: 0 }), 2), size = _c[0], setSize = _c[1];
    react.useLayoutEffect(function () {
        if (target) {
...
function usePromise(promiseFn, callbacksOrDeps, deps) {
    ...
    var promiseFnRef = react.useRef(promiseFn);
    var callbacksRef = react.useRef(callbacks);
    var requestIdRef = react.useRef(0);
    var activeRequestRef = react.useRef(null);
...
var useLazyImg = function (src, defaultSrc, errorSrc, actions) {
    ...
    var defaultSrcRef = react.useRef($defaultSrc);
    var errorSrcRef = react.useRef($errorSrc);
    var actionsRef = react.useRef($actions);
...
function useIndexedDB(dbName, version, upgradeCallback) {
    ...
    var upgradeCallbackRef = react.useRef(upgradeCallback);
    react.useEffect(function () {
...
function useToast(config) {
    ...
    var activeToastsRef = react.useRef(new Set());
    var delayedToastsRef = react.useRef(new Set());
    toastRef.current = react.useCallback(function (text, config) {
        ...
        var showToast = function () {
            ...
            ReactDom.flushSync(function () {
                root.render(jsxRuntime.jsx("div", __assign({ style: __assign(__assign(__assign({ position: _config.position }, placementStyle), _config.style), { color: _config.color, backgroundColor: _config.bgColor, padding: "4px 12px", paddingBottom: "6px", borderRadius: "4px", fontSize: "14px" }), className: _config.className }, { children: _config.text })));
            });
...
var createRoot = function (targetDocument) {
    var root = ReactDomClient.createRoot(targetDocument);
    return {
        render: function (element) {
            root.render(element);
        },
...
function useEyeDropper(options) {
    ...
    var _b = __read(react.useState(false), 2), isSupported = _b[0], setIsSupported = _b[1];
    var _c = __read(react.useState(initialValue), 2), sRGBHex = _c[0], setSRGBHex = _c[1];
    var mountedRef = react.useRef(false);
    react.useEffect(function () {
        mountedRef.current = true;
    ...
    var open = react.useCallback(function (openOptions) { return __awaiter(_this, void 0, void 0, function () {
...
var useScroll = function (callback) {
    var _a = __read(react.useState(getScrollPosition), 2), position = _a[0], setPosition = _a[1];
...
function useSingleton(createInstance) {
    var instanceRef = react.useRef(UNINITIALIZED);
...
var useQrcodeScan = function (options) {
    ...
    var _c = __read(react.useState("idle"), 2), status = _c[0], setStatus = _c[1];
    var _d = __read(react.useState(null), 2), result = _d[0], setResult = _d[1];
    var _e = __read(react.useState(null), 2), scanResult = _e[0], setScanResult = _e[1];
    var _f = __read(react.useState(null), 2), error = _f[0], setError = _f[1];
    var _g = __read(react.useState("none"), 2), mode = _g[0], setMode = _g[1];
    var _h = __read(react.useState(null), 2), cameraCapabilities = _h[0], setCameraCapabilities = _h[1];
    var _j = __read(react.useState(getInitialCameraPermissionState), 2), cameraPermission = _j[0], setCameraPermission = _j[1];
    var _k = __read(react.useState(function () { return ({
        isWechatEnv: service.getIsWechatEnv(),
        supportsNativeDetector: service.getSupportsNativeDetector(),
    }); }), 1), environment = _k[0];
    var mountedRef = react.useRef(false);
    var operationRef = react.useRef(0);
    var controlOperationRef = react.useRef(0);
    var permissionOperationRef = react.useRef(0);
    var permissionListenerRef = react.useRef(null);
    react.useEffect(function () {
        mountedRef.current = true;
        return function () {
            mountedRef.current = false;
    ...
    var isCurrent = react.useCallback(function (operation) {
        return mountedRef.current && operation === operationRef.current;
    }, []);
    var replacePermissionListener = react.useCallback(function (permissionStatus) {
    ...
    var refreshCameraPermission = react.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var start = react.useCallback(function (startOptions) {
    ...
    var stop = react.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var pause = react.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var resume = react.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var switchCamera = react.useCallback(function (cameraId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var getCameras = react.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var scanImage = react.useCallback(function (file, imageOptions) {
    ...
    var refreshCameraCapabilities = react.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var setTorch = react.useCallback(function (enabled) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var setZoom = react.useCallback(function (value) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var clearResult = react.useCallback(function () {
        setResult(null);
        setScanResult(null);
    }, []);
    ...
    var reset = react.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.QrcodeScanService = QrcodeScanService;
...
exports.useDimensionsById = useDimensionsById;
...
exports.useQrcodeScan = useQrcodeScan;
