...
import example1 from "@/views/docs/views/examples/UseReactorListener/example.1";
import pkg from "@/../package.json";
import UseReactorListenerApi from "@/views/docs/views/hooks-apis/useReactorListener.api";

export default function UseReactorListener() {
  const hooksName = "useReactorListener";
