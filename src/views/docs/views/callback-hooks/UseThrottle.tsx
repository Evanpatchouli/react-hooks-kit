...
import example1 from "@/views/docs/views/examples/UseThrottle/example.1";
import pkg from "@/../package.json";
import UseThrottleApi from "@/views/docs/views/hooks-apis/useThrottle.api";

export default function UseThrottle() {
  const hooksName = "useThrottle";
