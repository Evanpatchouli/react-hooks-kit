...
import example1 from "@/views/docs/views/examples/UseDebounce/example.1";
import pkg from "@/../package.json";
import UseDebounceApi from "@/views/docs/views/hooks-apis/useDebounce.api";

export default function UseDebounce() {
  const hooksName = "useDebounce";
