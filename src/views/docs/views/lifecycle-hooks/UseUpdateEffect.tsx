...
import example1 from "@/views/docs/views/examples/UseUpdateEffect/example.1";
import pkg from "@/../package.json";
import UseUpdateEffectApi from "@/views/docs/views/hooks-apis/useUpdateEffect.api";

export default function UseUpdateEffect() {
  const hooksName = "useUpdateEffect";
