...
import example1 from "@/views/docs/views/examples/UseAsyncEffect/example.1";
import example2 from "@/views/docs/views/examples/UseAsyncEffect/example.2";
import pkg from "@/../package.json";
import UseAsyncEffectApi from "@/views/docs/views/hooks-apis/useAsyncEffect.api";

export default function UseAsyncEffect() {
  const hooksName = "useAsyncEffect";
