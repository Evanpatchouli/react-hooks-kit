...
import example1 from "@/views/docs/views/examples/UseUnmount/example.1";
import pkg from "@/../package.json";
import UseUnmountApi from "@/views/docs/views/hooks-apis/useUnMount.api";

export default function UseUnmount() {
  const hooksName = "useUnMount";
