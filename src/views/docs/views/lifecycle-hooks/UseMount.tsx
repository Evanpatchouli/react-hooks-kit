...
import example1 from "@/views/docs/views/examples/UseMount/example.1";
import pkg from "@/../package.json";
import UseMountApi from "@/views/docs/views/hooks-apis/useMount.api";

export default function UseMount() {
  const hooksName = "useMount";
