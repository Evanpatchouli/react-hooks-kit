...
import example1 from "@/views/docs/views/examples/UseBeforeMount/example.1";
import pkg from "@/../package.json";
import UseBeforeMountApi from "@/views/docs/views/hooks-apis/useBeforeMount.api";

export default function UseBeforeMount() {
  const hooksName = "useBeforeMount";
