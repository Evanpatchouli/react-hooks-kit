...
import example1 from "@/views/docs/views/examples/UseAutoPageSize/example.1";
import pkg from "@/../package.json";
import UseAutoPageSizeApi from "@/views/docs/views/hooks-apis/useAutoPageSize.api";

export default function UseAutoPageSize() {
  const hooksName = "useAutoPageSize";
