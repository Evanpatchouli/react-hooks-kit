...
import example1 from "@/views/docs/views/examples/UseProvide/example.1";
import pkg from "@/../package.json";
import UseProvideApi from "@/views/docs/views/hooks-apis/useProvide.api";

export default function UseProvide() {
  const hooksName = "useProvide";
