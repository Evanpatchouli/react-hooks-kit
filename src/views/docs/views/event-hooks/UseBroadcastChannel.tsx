...
import example1 from "@/views/docs/views/examples/UseBroadcastChannel/example.1";
import pkg from "@/../package.json";
import UseBroadcastChannelApi from "@/views/docs/views/hooks-apis/useBroadcastChannel.api";

export default function UseBroadcastChannel() {
  const hooksName = "useBroadcastChannel";
