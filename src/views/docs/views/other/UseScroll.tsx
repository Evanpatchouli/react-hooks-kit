...
import example1 from "@/views/docs/views/examples/UseScroll/example.1";
import pkg from "@/../package.json";
import UseScrollApi from "@/views/docs/views/hooks-apis/useScroll.api";

export default function UseScroll() {
  const hooksName = "useScroll";
