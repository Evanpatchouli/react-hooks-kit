...
import example1 from "@/views/docs/views/examples/UseSingleTon/example.1";
import pkg from "@/../package.json";
import UseSingletonApi from "@/views/docs/views/hooks-apis/useSingleton.api";

export default function UseSingleTon() {
  const hooksName = "useSingleton";
