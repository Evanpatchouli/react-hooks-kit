...
import example1 from "@/views/docs/views/examples/UseWhyDidYouUpdate/example.1";
import pkg from "@/../package.json";
import UseWhyDidYouUpdateApi from "@/views/docs/views/hooks-apis/useWhyDidYouUpdate.api";

export default function UseWhyDidYouUpdate() {
  const hooksName = "useWhyDidYouUpdate";
