...
import example1 from "@/views/docs/views/examples/UseBattery/example.1";
import pkg from "@/../package.json";
import UseBatteryApi from "@/views/docs/views/hooks-apis/useBattery.api";

export default function UseBattery() {
  const hooksName = "useBattery";
