...
import example1 from "@/views/docs/views/examples/UseEyeDropper/example.1";
import pkg from "@/../package.json";
import UseEyeDropperApi from "@/views/docs/views/hooks-apis/useEyeDropper.api";

export default function UseEyeDropper() {
  const hooksName = "useEyeDropper";
