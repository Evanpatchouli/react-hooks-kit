...
import example1 from "@/views/docs/views/examples/UseMediaQuery/example.1";
import pkg from "@/../package.json";
import UseMediaQueryApi from "@/views/docs/views/hooks-apis/useMediaQuery.api";

export default function UseMediaQuery() {
  const hooksName = "useMediaQuery";
