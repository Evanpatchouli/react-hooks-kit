...
import example1 from "@/views/docs/views/examples/UseDimensionsById/example.1";
import pkg from "@/../package.json";
import UseDimensionsByIdApi from "@/views/docs/views/hooks-apis/useDimensionsById.api";

export default function UseDimensionsById() {
  const hooksName = "useDimensionsById";
