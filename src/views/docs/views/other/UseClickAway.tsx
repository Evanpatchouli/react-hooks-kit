...
import example1 from "@/views/docs/views/examples/UseClickAway/example.1";
import pkg from "@/../package.json";
import UseClickAwayApi from "@/views/docs/views/hooks-apis/useClickAway.api";

export default function UseClickAway() {
  const hooksName = "useClickAway";
