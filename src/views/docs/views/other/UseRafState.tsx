...
import example1 from "@/views/docs/views/examples/UseRafState/example.1";
import pkg from "@/../package.json";
import UseRafStateApi from "@/views/docs/views/hooks-apis/useRafState.api";

export default function UseRafState() {
  const hooksName = "useRafState";
