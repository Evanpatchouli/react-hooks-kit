...
import example1 from "@/views/docs/views/examples/UseKeyPress/example.1";
import pkg from "@/../package.json";
import UseKeyPressApi from "@/views/docs/views/hooks-apis/useKeyPress.api";

export default function UseKeyPress() {
  const hooksName = "useKeyPress";
