...
import example1 from "@/views/docs/views/examples/UseMousePosition/example.1";
import pkg from "@/../package.json";
import UseMousePositionApi from "@/views/docs/views/hooks-apis/useMousePosition.api";

export default function UseMousePosition() {
  const hooksName = "useMousePosition";
