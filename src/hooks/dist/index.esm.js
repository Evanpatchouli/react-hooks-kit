...
function useEventListener(eventName) {
    ...
    var _b = useState(null), eventResult = _b[0], setEventResult = _b[1];
...
var useLoading = function (loadingMap, options) {
    ...
    var _a = useState(loadingMap), loading = _a[0], _setLoading = _a[1];
...
var useTree = function (initialTree, options) {
    ...
    var _a = useState(initialTree), tree = _a[0], setTree = _a[1];
...
export { useAsyncEffect, useBatchHooks, useBattery, useBeforeMount, useBroadcastChannel, useClickAway, useConsoleLog, useCookie, useDebounce, useEventEmitter, useEventListener, useEyeDropper, useFetch, useForceUpdate, useForm, useGenerator, useGuide, useHover, useIndexedDB as useIndexDB, useKeyPress, useLazy, useLazyImage, useList, useLoading, useLocalStorage, useMediaQuery, useMemento, useMeta, useMixRef, useMount, useMousePosition, useNetworkStatus as useNetwork, useOverflow, usePrevious, usePromise, useProtect, useRaf, useRafState, useReactive, useReactor, useReactorListener, useResize, useSafeArea, useScroll, useSingleton, useTheme, useThrottle, useTickState, useTicker, useToast, useToggle, useTree, useUnmount as useUnMount, useUpdate, useUpdateEffect, useUpdateLayoutEffect, useUrl, useVirtualArea, useWatch, useWatchGetter, useWhyDidYouUpdate };
